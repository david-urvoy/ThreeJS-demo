...
uniform float uSmallWavesHeight;
...
void main() {
	...
	float height = 	sin(modelPosition.x * uWavesFrequency.x + uTime * uWavesSpeed) *
	...
	vec4 projectedProjection = projectionMatrix * viewPosition;
